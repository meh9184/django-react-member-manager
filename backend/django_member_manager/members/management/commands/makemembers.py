...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for i in range(member_length):
            ...
            print('Complete to make ' + str(i+1) + 'th ' + 'member : [ ' + name + ', ' + account + ', ' + password + ' ]')
